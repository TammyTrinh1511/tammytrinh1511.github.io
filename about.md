<div class="about-header">
  <img src="assets/profile.jpg" alt="Portrait of Tammy Trinh" class="about-avatar" width="160" height="160" loading="lazy" />
  <div class="about-header-content">
    <h1 class="title">Tammy Trinh</h1>
    <p class="about-subtitle">Data Science · AI Engineering &amp; Research</p>
  ...
  <a href="https://www.linkedin.com/in/tam-trinh-665a58187/" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://github.com/TammyTrinh1511" target="_blank" rel="noopener" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
  ...
  <a href="https://orcid.org/0009-0003-2402-6651" target="_blank" rel="noopener"
   style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
    <svg viewBox="0 0 24 24" role="img" aria-hidden="true"
         style="width:20px;height:20px;opacity:0.9;" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
        <path d="M12 0a12 12 0 1 0 12 12A12.014 12.014 0 0 0 12 0Zm-2.39 17.2H7.83V6.8h1.78ZM8.72 5.6A1.01 1.01 0 1 1 9.73 4.6a1 1 0 0 1-1.01 1Zm9.45 11.6h-1.78v-5.2c0-1.24-.55-2.01-1.7-2.01a1.85 1.85 0 0 0-1.73 1.19 2.34 2.34 0 0 0-.11.72v5.3h-1.78v-8.4h1.78v1.3a2.43 2.43 0 0 1 2.25-1.38c1.63 0 3.07 1.07 3.07 3.53Z"/>
    </svg>
    <span>ORCID</span>
  </a>
  ...
  <a href="mailto:trinhthiminhtamvq@gmail.com" style="display:inline-flex;align-items:center;gap:0.5rem;text-decoration:none;color:var(--color-accent-2);">
...
I am an undergraduate in Data Science in Economics and Business with a strong focus on AI Engineering, Information Retrieval (IR), and Multi-Agent Systems.

My work spans long-context modeling, fact-checking architectures, graph-based representations and reasoning, and agent-based orchestration using Large Language Models. I am particularly interested in the application of AI in economics, especially in finance, including predictive modeling, risk analysis, and decision-support systems powered by modern IR, knowledge graphs, and agentic techniques. I am currently developing research ideas around retrieval-augmented systems, graph-enhanced context-aware reasoning, and agentic workflows for reliable economic and financial decision support.

In my free time, I enjoy watching movies, playing table tennis, and exploring new music.
